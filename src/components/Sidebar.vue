...
<template>
    ...
    <button class="button" @click="hs.initializeMapForTesting">Set up 8x8 blank hexes</button>
    <div class="card">
        <header class="card-header">
            <div class="media-left">
                <figure class="image is-64x64">
                    <img v-bind="{ src: es.terrainToImage[hs.activeHex(es.activeHexID).terrain].file }">
                </figure>
                </div>
        ...
        <div class="card-content">
            <div class="card">
                ...
                <div class="card-content">
                    <TextEditor v-model="activeHex(es.activeHexID).content" />
                </div>
            </div>
            <div class="card">
                <header class="card-header has-background-primary" @click="es.toggleSection('terrain')">
                    <p class="card-header-title">
                        Terrain
                    </p>
